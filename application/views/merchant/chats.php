                                ...
                                foreach ($chats as $s) : ?>
                                    <tr>
                                        ...
                                        <td class="text-center">
                                            <img src="<?= base_url('assets/img/profile/') . $s['image']; ?>" alt="Profile <?= $s['name']; ?>" class="img-thumbnail" style="width: 30px;">&nbsp;
                                            <?= $s['name']; ?>
                                        </td>
                                        <td class="text-center text-danger"><?= ($s['belum_dibaca'] != 0) ? number_format($s['belum_dibaca'], 0, ",", ".") . ' pesan belum dibaca' : ''; ?></td>
                                        <td class="text-center">
                                            <a href="<?= base_url('merchant/chat/') . urlencode($s['email']); ?>" class="btn btn-sm mb-1 btn-success" id="editPasien">Buka</a>
                                            <!-- <a href="" data-href="<?= base_url('merchant/deletechat/') . $s['merchant_id']; ?>" class="btn btn-sm mb-1 btn-danger" data-toggle="modal" id="delArtikel" data-target="#deleteArtikelModal">Delete</a> -->
                                        </td>
                                    </tr>
                                <?php $no++;
                                endforeach; ?>
