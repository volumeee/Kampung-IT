        ...
        <div class="col-lg-12 mb-3">
            <div class="card shadow">
                <div class="my-auto card-body py-3 d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="ml-auto">
                        <a href="<?= base_url('member'); ?>" class="btn btn-sm btn-primary shadow-sm mb-1 mb-md-0">
            ...
            <div class="card">
                <div class="card-body row" style="height: 320px; overflow-y: auto;">
                    <?php foreach ($chat as $c) :
                        if ($c['identify'] == $this->session->userdata('email')) : ?>
                            <div class="col-lg-12">
                ...
                <div class="card-footer">
                    <form action="<?= base_url('member/sendchat'); ?>" method="POST" class="row">
